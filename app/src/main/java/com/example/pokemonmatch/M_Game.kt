...
class M_Game : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imgCont: Array<ImageView> = arrayOf(
            ...
            findViewById(R.id.c19), findViewById(R.id.c20)
        )
        ...
        //shuffle logic
        pokemonCont.shuffle()
        val pokemons = (pokemonCont.take(10) + pokemonCont.take(10)).shuffled()
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.mgame)) { v, insets ->
